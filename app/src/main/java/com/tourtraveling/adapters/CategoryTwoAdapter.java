...
public class CategoryTwoAdapter extends RecyclerView.Adapter<CategoryTwoAdapter.CategoryTwoVH> {

    private Context context;
    private final List<AddProductModel> list;

    public CategoryTwoAdapter(Context context, List<AddProductModel> list) {
    ...
    @NonNull
    @Override
    public CategoryTwoVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CategoryTwoVH(LayoutInflater
                .from(parent.getContext())
                .inflate(R.layout.item_category_layout, parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull CategoryTwoVH holder, int position) {
    ...
    public class CategoryTwoVH extends RecyclerView.ViewHolder {
        ...
        public CategoryTwoVH(@NonNull View itemView) {
            super(itemView);
